...
internal class BlogRepositoryTest {
    ...
    @Test
    internal fun fetchPostsWithDefaultLimitReturnsSuccessfulParsedPosts() = runTest {
        val feedUrl = "https://example.com/feed.xml"
        val mockClient = MockSuccessNetworkClient()
        val repository = BlogRepository(feedUrl, mockClient)
    ...
    @Test
    internal fun fetchPostsWithCustomLimitReturnsLimitedPosts() = runTest {
        val feedUrl = "https://example.com/feed.xml"
        val mockClient = MockSuccessNetworkClient()
        val repository = BlogRepository(feedUrl, mockClient)
    ...
    @Test
    internal fun fetchPostsHandlesNetworkError() = runTest {
        val feedUrl = "https://example.com/feed.xml"
    ...
    @Test
    internal fun fetchPostsWithZeroLimit() = runTest {
        val feedUrl = "https://example.com/feed.xml"
        val mockClient = MockSuccessNetworkClient()
        val repository = BlogRepository(feedUrl, mockClient)
    ...
    @Test
    internal fun fetchPostsWithNegativeLimit() = runTest {
        val feedUrl = "https://example.com/feed.xml"
        val mockClient = MockSuccessNetworkClient()
        val repository = BlogRepository(feedUrl, mockClient)
    ...
    @Test
    internal fun fetchPostsWithLargeLimit() = runTest {
        val feedUrl = "https://example.com/feed.xml"
        val mockClient = MockSuccessNetworkClient()
        val repository = BlogRepository(feedUrl, mockClient)
    ...
    @Test
    internal fun fetchPostsUsesDefaultNetworkClientWhenNotProvided() = runTest {
