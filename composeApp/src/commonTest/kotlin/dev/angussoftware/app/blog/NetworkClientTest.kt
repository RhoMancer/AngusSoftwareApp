...
internal class NetworkClientTest {
    ...
    @Test
    fun defaultNetworkClientReturnsFetcherValue() = runTest {
    ...
    @Test
    fun defaultNetworkClientPassesUrlToFetcher() = runTest {
        val passedUrls = mutableListOf<String>()
        val client = DefaultNetworkClient(fetcher = { url ->
            passedUrls += url
            "ignored"
        })
    ...
    @Test
    fun defaultNetworkClientPropagatesExceptions() = runTest {
    ...
    @Test
    fun customNetworkClientImplementationWorks() = runTest {
        val custom = object : NetworkClient {
