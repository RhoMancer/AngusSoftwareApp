...
internal object BuildFailureAnalysis {
    fun analyze(
        ...
        logger.lifecycle("[BuildFailure] Build failed; starting analysis (model=$model, timeout=${timeoutSec}s, maxPrompt=$maxPrompt, redact=$redact).")
